...
if __name__ == "__main__":
    pdf_path = Path("../data/pdfs/ETb_09_Tous_Jeu_Evaluation_Détaillé.pdf").resolve()
    out_path = Path("../data/json/bulletins_eval.json").resolve()
    ...
    print("OK ->", out_path)
    print("Nb bulletins:", len(bulletins))
    print("Nb lignes tableau total:", sum(len(b["table"]["rows"]) for b in bulletins))
